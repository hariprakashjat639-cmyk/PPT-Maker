...
# पेज सेटिंग्स और हेडर/फूटर छुपाना
st.set_page_config(page_title="Master Model Paper PPT Maker", page_icon="📊", layout="centered")
st.markdown("""
    <style>
...
st.title("📊 Master Gemini AI Bilingual PDF/Photo to PPT Maker")
st.write("आपकी API Key ऑटोमैटिक सेट है। बस फाइल अपलोड करें और परफेक्ट PPT बनाएं!")
...
def process_with_gemini(file_bytes, file_type, api_key):
    ...
    2. विकल्पों (Options) का क्रम हमेशा सही (1, 2, 3, 4 या A, B, C, D) వరుसे से सेट करें, भले ही इमेज में वे आगे-पीछे हों।
    3. यदि किसी प्रश्न का उत्तर या व्याख्या पीडीएफ में उपलब्ध नहीं है, तो उसे खाली छोड़ दें (फालतू चीजें न जोड़ें)।
    4. आउटपुट केवल इसी फॉर्मेट में होना चाहिए ताकि इसे आसानी से पढ़ा जा सके:
    ...
    O3: [विकल्प 3]
    O4: [विकल्प 4]
    Ans: [उत्तर यदि है तो लिखें, अन्यथा खाली छोड़ें]
    Exp: [व्याख्या यदि है तो लिखें, अन्यथा खाली छोड़ें]
    ---
    """
...
# पार्सर जो Gemini के क्लीन आउटपुट को पढ़ेगा
...
if uploaded_file is not None and gemini_api_key:
    if st.button("🚀 Master PPT Generate Karein"):
        with st.spinner("Gemini AI फाइल को समझ रहा है, शुद्ध कर रहा है और मास्टर PPT बना रहा है..."):
            ...
            if gemini_raw_text:
                ...
                for idx, q in enumerate(parsed_questions):
                    ...
                    # ==========================================
                    # SLIDE 2: Answer + Explanation (Sirf tabhi banegi jab answer/explanation data ho)
                    # ==========================================
                ...
                st.success("🎉 आपकी मास्टर PPT बिल्कुल सही शुद्धता और स्मार्ट स्लाइड रूल्स के साथ तैयार हो गई है!")
                st.download_button(
                    label="📥 Master PPT Download Karein",
                    data=ppt_stream,
